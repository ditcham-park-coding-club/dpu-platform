...
instructions = 'Get rid of the boxes to push Homophobic Harold into the bin and release his prisoners!'
...
def is_complete():
    ...
    if homophobicharold.hit is bin and not any_issy_boxes:
        return True
